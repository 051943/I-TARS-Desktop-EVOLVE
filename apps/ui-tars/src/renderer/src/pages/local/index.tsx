import { MessageCirclePlus, Layers } from 'lucide-react';
...
import { OperationManualPanel } from '../../components/OperationManual';
        ...
        <Card className="flex-1 basis-3/5 p-3 h-[calc(100vh-76px)]">
          <Tabs defaultValue="screenshot" className="flex-1">
            <TabsList>
              ...
              <TabsTrigger value="operation-manual">
            ...
            <TabsContent value="operation-manual" className="h-full">
              <OperationManualPanel />
            </TabsContent>
          </Tabs>
        </Card>
      </div>
